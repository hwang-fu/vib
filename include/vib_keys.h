...
#define vib_key_combo_ctrl(key)     ((key & VIB_CTRL) != 0)
#define vib_key_combo_alt(key)      ((key & VIB_ALT)  != 0)
#define vib_key_combo_shift(key)    ((key & VIB_SHIFT) != 0)
#define vib_key_base(key)           (key & (~VIB_MASK))
